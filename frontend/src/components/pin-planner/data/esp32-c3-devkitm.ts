...
export const esp32C3DevKitM: BoardVariant = {
  id: "esp32-c3-devkitm",
  name: "ESP32-C3-DevKitM-1 (26-pin)",
  shortName: "ESP32-C3",
  chipFamily: "ESP32-C3",
  pinCount: 26,
  layout: {
  ...
  components: [
    ...
    },
    {
      ...
      bounds: { x: 145, y: 340, w: 30, h: 20 },
    },
  ],
  pins: [
    // Left side (positions 1–13), top to bottom
    {
      position: 1,
      side: "left",
      label: "3V3",
    ...
    },
    {
      ...
      functions: [
        ...
        { category: "spi", label: "SPI MISO", description: "FSPIQ / SPI MISO" },
      ],
      warnings: [
    ...
    },
    {
      ...
      functions: [
        ...
        { category: "spi", label: "SPI CLK", description: "FSPICLK / SPI clock" },
        { category: "i2c", label: "SCL", description: "Default I2C clock (Arduino)" },
      ],
      warnings: [],
    },
    {
      ...
      functions: [
        ...
        { category: "spi", label: "SPI MOSI", description: "FSPID / SPI MOSI" },
    ...
    },
    {
      ...
      functions: [
        ...
        { category: "uart", label: "UART0 TX", description: "UART0 transmit (USB serial)" },
      ],
      warnings: [
        { severity: "warning", text: "Used by USB Serial/JTAG for TX — avoid if using built-in USB" },
      ],
    },
    {
      position: 10,
      ...
      functions: [
        ...
        { category: "uart", label: "UART0 RX", description: "UART0 receive (USB serial)" },
      ],
      warnings: [
        { severity: "warning", text: "Used by USB Serial/JTAG for RX — avoid if using built-in USB" },
      ],
    },
    {
      position: 11,
    ...
    // Right side (positions 14–26), top to bottom
    {
      position: 14,
      side: "right",
      label: "GND",
    ...
    },
    {
      ...
      functions: [
        ...
        { category: "spi", label: "SPI CS", description: "FSPICS0 / SPI chip-select" },
        { category: "i2c", label: "SDA", description: "Default I2C data (Arduino)" },
      ],
      warnings: [],
    },
    {
