...
const securityHeaders = [
  ...
  },
  {
    ...
    value: [
      ...
      "font-src 'self'",
      "img-src 'self' data: blob: https://app.lemonsqueezy.com https://assets.lemonsqueezy.com",
      "frame-src https://www.youtube.com https://app.lemonsqueezy.com https://*.lemonsqueezy.com",
      "connect-src 'self' https://app.lemonsqueezy.com https://assets.lemonsqueezy.com https://iotivate-backend.onrender.com",
